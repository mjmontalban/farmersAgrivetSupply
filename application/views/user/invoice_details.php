      ...
      <div class="container-fluid">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                    ...
                    <small class="float-right">Date: <?php echo $orders[0]["purchased_date"]; ?></small>
                  </h4>
                </div>
                <!-- /.col -->
              </div>
              ...
              <div class="row invoice-info">
                ...
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                  <b>Invoice <?php echo '#'.$orders[0]["invoice_id"]; ?></b><br>
                  <br>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                        <?php $total = 0; foreach($orders as $key => $order): ?>
                            <tr>
                                <td><?php echo  $order["purchased_qty"]; ?></td>
                        ...
                        <?php  
                    $subtotal = str_replace(',','',$order["total_payment"]);
