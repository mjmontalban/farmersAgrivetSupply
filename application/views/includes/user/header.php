        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('users/soldItems'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            <a href="<?php echo base_url("users/purchase"); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url("users/invoiceSearch"); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url("users/accountSettings"); ?>" class="nav-link">
